...
import test.lab.vision.BaseActivity;
import test.lab.vision.R;
import test.lab.vision.TrackingActivity;

public class CameraCalibrationActivity extends BaseActivity implements CvCameraViewListener2, OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView.setMaxFrameSize(TrackingActivity.MAX_FRAME_WIDTH, TrackingActivity.MAX_FRAME_HEIGHT);
...
//            inputFrame.rgba();
    ...
    @Override
    protected void getBitmapFromStream(Mat mat) {
        mDroneMat = mat;
    }
}
